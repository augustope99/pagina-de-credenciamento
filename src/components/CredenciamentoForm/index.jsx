...
export default function CredenciamentoForm({ onSuccess, onRename }) {
  ...
  const razaoSocial = watch('razaoSocial');

  useEffect(() => {
    if (onRename && razaoSocial) {
      onRename(razaoSocial);
    }
  }, [razaoSocial, onRename]);
  ...
  // --- Funções de Máscara (Formatação Universal) ---
  ...
  const maskPhone = (value) => {
    return String(value)
      ...
      .replace(/^(\d{2})(\d)/g, '($1) $2')
      .replace(/(\d)(\d{4})$/, '$1-$2')
      .slice(0, 15); // Limita tamanho (11) 91234-5678
  };
  ...
  useEffect(() => {
    if (companyData) {
      ...
      if (companyData.cep) {
        setValue('cep', maskCEP(String(companyData.cep)));
      }
      ...
      if (companyData.cnpj) {
        const formattedCnpj = maskCNPJ(companyData.cnpj);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // 3. Enviar e-mail
      await sendEmail({
        to: "demo@example.com", // E-mail de teste para portfólio
        ...
        <div className="form-group full-width" style={{ marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
            <input
              ...
              maxLength={18}
              {...register('cnpjCheck', { required: true, onChange: (e) => e.target.value = maskCNPJ(e.target.value) })}
        ...
        {(complianceStatus.type === 'success' || complianceStatus.type === 'warning') && (
          <div className="form-grid fade-in">
            ...
            <div className="partner-group">
              <div className="form-group">
                ...
                <select id="marca" {...register('marca', { required: true })}>
                  ...
                  <option value="DISAPE">DISAPE</option>
                  <option value="REAL DUAS RODAS">REAL DUAS RODAS</option>
                </select>
              </div>
              <div className="form-group">
                <label htmlFor="codigoCliente">Código do Cliente *</label>
                <input type="text" id="codigoCliente" {...register('codigoCliente', { required: true, onChange: (e) => e.target.value = maskNumbers(e.target.value) })} />
              </div>
            </div>

            <div className="form-group">
              <label htmlFor="cnpj">CNPJ *</label>
              <input type="text" id="cnpj" maxLength={18} placeholder="00.000.000/0000-00" {...register('cnpj', { required: true, onChange: (e) => e.target.value = maskCNPJ(e.target.value) })} />
            </div>
            ...
            <div className="form-group">
              ...
              <input type="text" id="cep" maxLength={9} placeholder="00000-000" {...register('cep', { required: true, onChange: (e) => e.target.value = maskCEP(e.target.value) })} onBlur={handleCepBlur} />
            </div>
            <div className="form-group">
            ...
            <div className="partner-group">
              <div className="form-group">
                ...
                <input type="text" id="numero" {...register('numero', { required: true, onChange: (e) => e.target.value = maskNumbers(e.target.value) })} />
              </div>
              <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="tel" id="whatsapp" maxLength={15} placeholder="(00) 00000-0000" {...register('whatsapp', { required: true, onChange: (e) => e.target.value = maskPhone(e.target.value) })} />
            </div>
            ...
            <div className="partner-group">
              <div className="form-group">
                ...
                <input type="tel" id="telefone1" maxLength={15} placeholder="(00) 0000-0000" {...register('telefone1', { onChange: (e) => e.target.value = maskPhone(e.target.value) })} />
              </div>
              <div className="form-group">
                <label htmlFor="telefone2">Telefone 2 (DDD/Número)</label>
                <input type="tel" id="telefone2" maxLength={15} placeholder="(00) 0000-0000" {...register('telefone2', { onChange: (e) => e.target.value = maskPhone(e.target.value) })} />
              </div>
            </div>
            ...
            <div className="partner-group">
              <div className="form-group">
                ...
                <input type="text" id="cpfResponsavel" maxLength={14} placeholder="000.000.000-00" {...register('cpfResponsavel', { required: true, onChange: (e) => e.target.value = maskCPF(e.target.value) })} />
              </div>
              <div className="form-group">
            ...
            <div className="partner-group">
              ...
              <div className="form-group">
                ...
                <input type="text" id="cpfSocio2" maxLength={14} placeholder="000.000.000-00" {...register('cpfSocio2', { onChange: (e) => e.target.value = maskCPF(e.target.value) })} />
              </div>
            </div>
            <div className="partner-group">
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <input type="text" id="cpfSocio3" maxLength={14} placeholder="000.000.000-00" {...register('cpfSocio3', { onChange: (e) => e.target.value = maskCPF(e.target.value) })} />
              </div>
            </div>
            <div className="partner-group">
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <input type="text" id="cpfSocio4" maxLength={14} placeholder="000.000.000-00" {...register('cpfSocio4', { onChange: (e) => e.target.value = maskCPF(e.target.value) })} />
              </div>
            </div>
            ...
            <div className="partner-group">
              <div className="form-group">
                ...
                <input type="text" id="cnpjConta" maxLength={18} placeholder="00.000.000/0000-00" {...register('cnpjConta', { required: true, onChange: (e) => e.target.value = maskCNPJ(e.target.value) })} />
              </div>
              <div className="form-group">
            ...
            <div className="partner-group">
              ...
              <div className="form-group">
                ...
                <input type="text" id="codigoBanco" {...register('codigoBanco', { required: true, onChange: (e) => e.target.value = maskNumbers(e.target.value) })} />
              </div>
            </div>
            <div className="partner-group">
              <div className="form-group">
                <label htmlFor="agencia">Agência *</label>
                <input type="text" id="agencia" {...register('agencia', { required: true, onChange: (e) => e.target.value = maskNumbers(e.target.value) })} />
              </div>
              <div className="form-group">
                <label htmlFor="contaDigito">Conta/Dígito *</label>
                <input type="text" id="contaDigito" placeholder="00000-0" {...register('contaDigito', { required: true, onChange: (e) => e.target.value = maskNumbers(e.target.value) })} />
              </div>
            </div>
            <div className="form-group full-width">
